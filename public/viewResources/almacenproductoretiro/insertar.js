...
$(function()
{
	$('#frmInsertarAlmacenProductoRetiro').formValidation(
	{
		framework: 'bootstrap',
...
function onChangeSelectNombreProducto()
{
	...
	agregarProducto(
		...
		dataSelectNombreProducto[indexTemp].row.tpresentacion.nombre,
		dataSelectNombreProducto[indexTemp].row.tunidadmedida.nombre,
...
function enviarFrmInsertarAlmacenProductoRetiro()
{
	...
	$('#frmInsertarAlmacenProductoRetiro').data('formValidation').resetForm();
	$('#frmInsertarAlmacenProductoRetiro').data('formValidation').validate();

	if( ! $('#frmInsertarAlmacenProductoRetiro').data('formValidation').isValidField('selectNombreOficina')||
		! $('#frmInsertarAlmacenProductoRetiro').data('formValidation').isValidField('selectAlmacenOrigen'))
	{
	...
	confirmacionEnvio('frmInsertarAlmacenProductoRetiro');
}
...
function guardarNombreAlmacenOrigen()
{
	...
	$('#hdCodigoAlmacenOrigen').val($("#selectAlmacenOrigen").val());
}
