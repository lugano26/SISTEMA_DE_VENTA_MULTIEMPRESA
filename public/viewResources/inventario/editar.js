...
$(function() {
    ...
    $('#frmEditarInventario').formValidation(
    {
        framework: 'bootstrap',
...
function enviarFrmEditarInventario()
{
	var isValid=null;
    var $form = $('#frmEditarInventario'),
	...
	confirmacionEnvio('frmEditarInventario');
}
...
{
    $('#frmEditarInventario').data('formValidation').validateField('selectAmbiente');
		
    var isValid= $('#frmEditarInventario').data('formValidation').isValidField('selectAmbiente');
