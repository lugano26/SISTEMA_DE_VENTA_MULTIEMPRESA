...
$(function()
{
	$('#frmInsertarProductoTrasladoOficina').formValidation(
	{
		framework: 'bootstrap',
...
function enviarFrmInsertarProductoTrasladoOficina()
{
	...
	$('#frmInsertarProductoTrasladoOficina').data('formValidation').resetForm();
	$('#frmInsertarProductoTrasladoOficina').data('formValidation').validate();

	if( ! $('#frmInsertarProductoTrasladoOficina').data('formValidation').isValidField('selectNombreOficinaDestino') ||
		! $('#frmInsertarProductoTrasladoOficina').data('formValidation').isValidField('selectNombreOficinaOrigen'))
	{
	...
	confirmacionEnvio('frmInsertarProductoTrasladoOficina');
}
