	...
	<div class="col-md-12">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				<li class="active"><a href="#tab_1-1">Datos del almacén</a></li>
			</ul>
			<div class="tab-content">
				<form id="frmInsertarAlmacen" action="{{url('almacen/insertar')}}" method="post">
					<div class="tab-pane active" id="tab_1-1">
						...
						<div class="row">
							<div class="col-md-12">
								{{csrf_field()}}
								<input type="button" class="btn btn-primary pull-right" value="Registrar datos ingresados" onclick="enviarFrmInsertarAlmacen();">
							</div>
						</div>
					</div>
				</form>
...
<script src="{{asset('viewResources/almacen/insertar.js?x='.env('CACHE_LAST_UPDATE'))}}"></script>
@endsection