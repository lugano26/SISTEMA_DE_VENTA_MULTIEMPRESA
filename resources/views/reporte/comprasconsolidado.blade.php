		...
		<div class="nav-tabs-custom">
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1-1">
					<div class="row">
						<div class="col-md-12">
							<form id="frmFiltro" method="post" action="{{url('reporte/comprasconsolidado')}}">
							<div class="row">
...
<script src="{{asset('viewResources/reporte/comprasconsolidado.js?x='.env('CACHE_LAST_UPDATE'))}}"></script>