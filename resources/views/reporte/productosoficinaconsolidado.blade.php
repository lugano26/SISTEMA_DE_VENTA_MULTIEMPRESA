		...
		<div class="nav-tabs-custom">
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1-1">
					<div class="row">
						<div class="col-md-12">
							<form id="frmFiltro"  method="post" action="{{url('reporte/productosoficinaconsolidado')}}">	
							<div class="row">																
								<div class="form-group col-md-6">
									<div class="form-group">
										<label>Oficina</label>
										<select id="codOficina" name="codOficina" class="selectStatic" onchange="guardarNombreOficinaOrigen()" style="width: 100%;">
								...
								<div class="form-group col-md-6">
									<div class="form-group">
										...
										<select id="filtroProductos" name="filtroProductos" class="selectStaticNonClear" style="width: 100%;">
...
<script src="{{asset('viewResources/reporte/productosoficinaconsolidado.js?x='.env('CACHE_LAST_UPDATE'))}}"></script>