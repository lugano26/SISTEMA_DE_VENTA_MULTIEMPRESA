				...
				<tr>
					...
					<td style="width: 270px;">
						<div style="border: 2px solid #4B89CC;">
							...
							<div style="font-size: 15px;padding: 5px;">{{$tReciboVentaPago->codigoReciboVentaPagoOutEf}}</div>
						</div>
					</td>
				</tr>
			</tbody>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align: center;vertical-align: top;">
						...
						<div style="border: 1px solid #999999;margin: 4px;padding: 5px;">S/{{number_format($tReciboVenta->treciboventaletraoutef->sum('pagado'), 2)}}</div>
						<div style="border: 1px solid #999999;margin: 4px;padding: 5px;">S/{{number_format($tReciboVenta->treciboventaletraoutef->sum('porPagar'), 2)}}</div>
					</td>
				</tr>
			</tbody>
		</table>
