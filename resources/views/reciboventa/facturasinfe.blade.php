...
@if($tEmpresa->formatoComprobante=='Ticket')
	<body style="font-family: 'Calibri (Body)';font-size: 16px;padding-left: 20px;">
		<div style="text-align: center;">*** RECIBO - F : {{$tReciboVenta->numeroRecibo}} ***</div>
		<br>
				...
				<tr>
					...
					<td style="width: 270px;">
						<div style="border: 2px solid #4B89CC;">
							...
							<div style="background-color: #f5f5f5;font-size: 15px;margin: 1px;padding: 7px;">RECIBO - F</div>
