...
@if($tEmpresa->formatoComprobante=='Ticket')
	<body style="font-family: 'Calibri (Body)';font-size: 16px;padding-left: 20px;">
		<div style="text-align: center;">*BOL. ELECTRÓNICA : {{$tReciboVenta->numeroRecibo}}*</div>
		<br>
		...
		<div style="text-align: center;">
			<div>
				Representación impresa de la boleta electrónica. Para consultar el documento visita <a href="{{$tEmpresa->urlConsultaFactura}}">{{$tEmpresa->urlConsultaFactura}}</a>
			</div>
			<img src="{{$base64Qr}}">
		</div>
	</body>
				...
				<tr>
					...
					<td style="width: 270px;">
						<div style="border: 2px solid #4B89CC;">
							...
							<div style="background-color: #f5f5f5;font-size: 15px;margin: 1px;padding: 7px;">BOLETA ELECTRÓNICA</div>
