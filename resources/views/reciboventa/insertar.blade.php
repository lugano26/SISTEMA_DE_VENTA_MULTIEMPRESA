...
<link rel="stylesheet" href="{{asset('viewResources/reciboventa/insertar.css?x='.env('CACHE_LAST_UPDATE'))}}">
<div class="row">
	<div class="col-md-12">
		<div class="nav-tabs-custom">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1-1">
					<form id="frmInsertarReciboVenta" action="{{url('reciboventa/insertar')}}" method="post">
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									...
									<table id="tableProducto" class="table table-striped verifyForCloseTable1" style="min-width: 777px;">
										...
										<tbody>
											<tr style="background-color: #ffffff;">
												...
												<td></td>
												<td></td>
												<td class="text-right" colspan="2" style="border: 1px solid #999999;padding: 1px;user-select: none;">
													<select id="selectDivisa" name="selectDivisa" class="form-control" onchange="applyCurrency(this.value, true, false);">
														<option value="Soles" {{(old('selectDivisa')=='Soles' ? 'selected' : '')}}>Venta en soles (S/)</option>
														<option value="Dólares" {{(old('selectDivisa')=='Dólares' ? 'selected' : '')}}>Venta en dólares (US$)</option>
													</select>
												</td>
...
<script src="{{asset('viewResources/reciboventa/insertar.js?x='.env('CACHE_LAST_UPDATE'))}}"></script>
@endsection