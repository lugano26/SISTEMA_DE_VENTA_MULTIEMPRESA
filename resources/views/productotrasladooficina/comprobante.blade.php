			...
			<tbody>
				<tr>
					<td style="width: 550px;">
						<fieldset>
							<legend><b>Oficina origen</b></legend>
							{{$tProductoTrasladoOficina->toficina->descripcion}}
						</fieldset>
					</td>
					<td style="text-align: center;">
						<fieldset>
							<legend><b>Estado</b></legend>
							{{$tProductoTrasladoOficina->estado ? 'Conforme' : 'Anulado'}}
						</fieldset>
					</td>
				</tr>
				<tr>
					<td style="padding-top: 5px;width: 550px;">
						<fieldset>
							<legend><b>Oficina llegada</b></legend>
							{{$tProductoTrasladoOficina->toficinallegada->descripcion}}
						</fieldset>
					...
					<td style="padding-top: 5px;text-align: center;">
						<fieldset>
							...
							{{substr($tProductoTrasladoOficina->created_at, 0, 10)}}
						</fieldset>
					</td>
				</tr>
			</tbody>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align: center;vertical-align: top;">
						 <div style="border: 1px solid #999999;margin: 4px;margin-top: 2px;padding: 5px;">S/{{{number_format($tProductoTrasladoOficina->tproductotrasladooficinadetalle->sum('precioCompraUnitarioProducto'),2, '.', '')}}}</div>
					</td>
					<td style="text-align: center;vertical-align: top;">
                        <div style="border: 1px solid #999999;margin: 4px;margin-top: 2px;padding: 5px;">S/{{number_format($tProductoTrasladoOficina->tproductotrasladooficinadetalle->sum('precioVentaUnitarioProducto'),2, '.', '')}}</div>
					</td>
				</tr>
			</tbody>
		</table>
